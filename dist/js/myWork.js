 ...
 ********************************************************/
class Project{
    constructor(images = [], imageAmount, projectName, projectBrief, projectDesc, projectURL){
        this.images = images;
...
const SmartMirror = ['dist/img/projects/SmartMirror/screen1.png', 
...
var projects = []; 
projects[0] = new Project(SmartMirror, 6, "Smart Mirror", "Android Studio / Firebase / Java", "Smart Mirror is an android application. Smart Mirror is used to control a Smart Mirror microcontroller system via Firebase Real-time database. The application is developed with Android Studio and Java Programming language.", "https://github.com/Trung28899/SmartMirror4");
projects[1] = new Project(PizzaOrder, 4, "Pizza Application", "Android Studio / XML / Java", "Pizza Order is an android application. Using Pizza Order, customers can choose their favorite pizza with delicious topping quick and easily. The application is developed with Android Studio and Java programming language.", "https://github.com/Trung28899/PizzaOrder");
projects[2] = new Project(Portfolio, 4, "Portfolio", "HTML / SASS / JavaScript", "Portfolio is a website project where I reviewed and sharpened my HTML5, SASS and JavaScript skills. This is where I introduce about myself, my work experience, projects, contacts and possibly my blogs in the future.", "index.html");
projects[3] = new Project(Xdelivery, 3, "VietCan Xdelivery", "HTML / CSS / JavaScript", "Xdelivery is my freelance project for a VietNamese company based in Toronto. This project supposed to be a web page for company's delivery service. Unfortunately, the contract was terminated when the project is half-done.", "https://xdelivery.netlify.com/");
projects[4] = new Project(Designs, 8, "Desgined Posters", "Adobe Photoshop / Canvas", "Most of the designs here were made when I was freelancing for a Toronto based marketing company - Tho Dia Canada. My role was a Poster Designer and Content Creator about Immigration and mostly Studying Aboard in Canada.", "https://github.com/Trung28899/Designs");
